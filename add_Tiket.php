<?php
ob_start();
include_once __DIR__. '/general/fun.php';
...
$sql = "INSERT INTO parties (name, date, time, location, price, description, image) VALUES (?, ?, ?, ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);
$stmt->bind_param('ssssdss', $name, $date, $time, $location, $price, $description, $image_path);
$stmt->execute();
