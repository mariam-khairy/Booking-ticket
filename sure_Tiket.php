                    ...
                    <div class="row align-items-center w-100">
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="data-left">
                                <div class="text-start">
                                    ...
                                    <p class="text-light">Sun 07 May 2023 08 : 30 PM - Sun 07 May 2023 11 : 00 PM</p>
                                </div>
                        ...
                        <div class="col-12 col-md-5 text-light text-start">
                            ...
                            <div class="row ms-1 borderbottom">
                                ...
                                <div class="col-3 student-price">150$</div>
                                <div class="col-3 other-price">100$</div>
                            </div>
                            <div class="row ms-1 borderbottom mb-3 mt-3">
                                <div class="col-6 p-0">
                                    <p>Total</p>
                                ...
                                <div class="col-6 pe-md-5">
                                    <p class="text-end total-price">12000$</p>
                                </div>
                            </div>
