...
$user = new User();
    ...
    if (empty($errors)) {
        ...
        // Set the data to be stored in the QR code
    ...
    $pixel_size = 20; // Pixel size of each module (square block) in the QR code
    $frame_size = 5; // Size of the white border around the QR code
    
    // Generate the QR code and save as a PNG file
    ...
    if ($user->create()) {
        ...
        $body = "Hello {$_POST['first_name']} {$_POST['last_name']} . Your Verifcation Code is:<br>$code<br>
        Thank you.";
...
<body>
    ...
    <aside class="left-side">
        ...
        <a href=""><i class="fa-regular fa-address-card"></i> About Us</a>
        <a href=""><i class="fa-regular fa-address-card"></i> Contact Us</a>
        <a href=""><i class="fa-regular fa-address-card"></i> Collections</a>
    </aside>
