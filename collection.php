                ...
                <div class="col-6 col-md-3 btns">
                    <div class="row justify-content-lg-evenly justify-content-end">
                        ...
                        <?php
                            if(isset($user)){
                                ?>
                                <span class="digit"><?=$user->first_name?>  <?=$user->last_name?> <i class="ti-angle-down"></i></span>
    ...
    <div class="col-md-4">
        <div class="card border-0">
            ...
            <div class="card-body p-2">
                ...
                <p class="card-text m-0"><strong>Price:</strong> <?= $party['price'] ?></p>
                ...
                <p class="card-text m-0"><a href="#" class="btn btn-primary">Buy Now</a></p>
            </div>
        </div>
    </div>
    <?php
