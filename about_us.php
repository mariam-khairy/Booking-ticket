...
<body>
    ...
    ?>
        ...
        <a href="about.php"><i class="fa-regular fa-address-card"></i> About Us</a>
        <a href="contact.php"><i class="fa-regular fa-address-card"></i> Contact Us</a>
    ...
    <section class="contact mt-5">
        <div class="container">
            ...
            <div class="row pb-5 align-items-center">
                <div class="col-12">
                    <div class="contact-number d-flex align-items-center mb-3">
                        <i class="fa-solid fa-phone me-3 "></i>
                        <p class="text-light mb-0">01126554981</p>
                    </div>
                    <div class="contact-number d-flex align-items-center mb-3">
                        <i class="fa-solid fa-phone me-3"></i>
                        <p class="text-light mb-0">01126554981</p>
                    ...
                    <div class="contact-number d-flex align-items-center mb-3">
                        ...
                        <p class="text-light mb-0">basem@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
